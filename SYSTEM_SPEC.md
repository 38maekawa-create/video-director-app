...
| 自己成長 | FB学習・パターン認識で品質基準自体が進化する（feedback_learner: 10パターン5ルール蓄積、edit_learner: 未稼働0件、video_patterns: 65件） |
...
│   │   └── template.py                ← テンプレート
│   └── tracker/                        ← トラッキング・FB学習
│       ├── feedback_learner.py         ← FB学習（10パターン5ルール蓄積）
│       ├── edit_learner.py             ← 編集学習（未稼働: 0パターン0ルール）
...
| # | 問題 | 状態 |
|---|------|------|
| 1 | edit_learnerが未稼働（0パターン0ルール。feedback_learnerは10+5件蓄積済み） | ⚠️ edit_learner稼働が先。Supabase移行の前提 |
| 2 | 概要欄未生成38% | ⏳ 原因調査必要 |
